...
document.addEventListener("DOMContentLoaded", () => {
    const pyStyles = document.createElement("style");
    ...
    pyConfig.innerHTML = JSON.stringify({
        packages: [...new Set([...pyScript.innerHTML.matchAll(modules)].map(m => m[1]))],
    });
    pyStyles.innerHTML = "py-terminal, pre { all: unset !important; }";
    document.body.appendChild(pyStyles);
})